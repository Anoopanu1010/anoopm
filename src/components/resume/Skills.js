    ...
    >
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <p className="text-sm text-black tracking-[4px] uppercase">   
            Features
          </p>
          <h2 className="text-3xl md:text-4xl text-green font-bold">Non-Technical Proficiency</h2>
        </div>
      ...
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-4xl text-green font-bold">Technical Expertise</h2>
        </div>
